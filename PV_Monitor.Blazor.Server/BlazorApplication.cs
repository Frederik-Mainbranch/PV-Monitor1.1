...
namespace PV_Monitor.Blazor.Server {
    public partial class PV_MonitorBlazorApplication : BlazorApplication {
        public PV_MonitorBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void PV_MonitorBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
